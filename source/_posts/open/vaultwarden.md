...
| 变量 | 说明 | 推荐值 |
| --- | --- | --- |
| DOMAIN | 你的域名（含协议） | <https://vault.example.com> |
| SIGNUPS_ALLOWED | 是否开放注册 | false（自建建议关闭） |
| ADMIN_TOKEN | 管理后台访问令牌 | 随机生成强密码 |
