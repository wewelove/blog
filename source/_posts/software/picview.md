---
title: PicView 快速免费开源看图工具
abbrlink: a90b1caf
date: 2025-11-05 10:13:20
categories:
  - - 软件
    - 图形设计
  - - 开源
...
![封面](../../images/picview/20251105104646.png)

::: center
{% btn https://github.com/Ruben2776/PicView, GitHub, fab fa-github, default outline %}
{% btn https://picview.org/, 官方网站, fas fa-home, blue outline %}
{% btn https://picview.chitaner.com/zh-cn/, 使用手册, fas fa-book, green outline %}
:::
...
::: download
{% btn https://picview.org/download, 官网下载, iconfont icon-guanwang, blue outline %}
{% btn https://github.com/Ruben2776/PicView/releases, GitHub 下载, fab fa-github, outline %}
:::

## 软件授权

:::
{% btn https://github.com/sponsors/Ruben2776, 免费 - 捐赠助力, iconfont icon-coffee, red outline %}
{% btn https://github.com/Ruben2776/PicView, 开源 - 参与贡献, iconfont icon-open-source, green outline %}
:::
