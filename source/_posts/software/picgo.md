...
![封面](../../images/picgo/20251105111146.png){.cover}

::: center
{% btn https://github.com/Molunerfinn/PicGo, GitHub, fab fa-github, default outline %}
{% btn https://molunerfinn.com/PicGo/, 官方网站, fas fa-home, blue outline %}
{% btn https://picgo.github.io/PicGo-Doc/zh/guide/, 使用手册, fas fa-book, green outline %}
:::
...
::: download
{% btn https://github.com/Molunerfinn/PicGo/releases, GitHub 下载, fab fa-github, outline %}
{% btn https://mirrors.sdu.edu.cn/github-release/1762304115/github-release/Molunerfinn_PicGo/, 山东大学镜像站, iconfont icon-yunfuwuqi, orange outline %}
:::
...
{% btn https://github.com/Molunerfinn/picgo, 开源 - 参与贡献, iconfont icon-open-source, green outline %}
:::
