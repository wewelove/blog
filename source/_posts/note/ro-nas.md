---
title: Ro：基于洛雪音乐二次开发的 NAS 音乐下载服务，自建音乐库的利器
...
categories:
  - [笔记]
description: 基于 lx-music 音源生态，专为 NAS 场景打造。不内置任何音源，音源由用户自行导入。
---
...
- 买了 NAS，想搭建一个属于自己的音乐库，却发现没有好用的下载工具
- 洛雪音乐（lx-music）很好用，但它是桌面端应用，没法跑在 NAS 上 7×24 小时在线
- 想 Docker 一键部署，却发现现有方案要么太重、依赖太多，要么功能残缺
- 音源挂了没人通知，下了半天的歌其实是降级音质，毫无感知

如果你中了以上任何一条，Ro 可能就是你要找的那个工具。
